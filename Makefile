...
CFLAGS_PRIVILEGE=
OPTLEVEL= -Os -march=native $(CFLAGS_PRIVILEGE) -DSISA_GIT_HASH=\"$(GIT_HASH)\"
#"
MORECFLAGS=-DUSE_COMPUTED_GOTO -DUSE_TERMIOS -DUSE_UNSIGNED_INT -DATTRIB_NOINLINE -DNO_SEGMENT
SDL2CFLAGS=-DUSE_COMPUTED_GOTO -DUSE_SDL2 -DUSE_UNSIGNED_INT -DNO_SEGMENT
