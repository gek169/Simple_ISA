...
&&G_ILLDB,
&&G_ILLDAA,&&G_ILLDBB,&&G_ILLDAB,&&G_ILLDBA,
&&G_CA,&&G_CB,&&G_AC,&&G_BC,
...
TB: /**/
{
		...
		if(REG_SAVER[EMULATE_DEPTH].ACTION_FLAGS == 1){ /*We must store the segment.*/
		...
		if(REG_SAVER[EMULATE_DEPTH].ACTION_FLAGS == 1){ /*We must load the segment.*/
